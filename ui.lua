...
function Library:create(options)
	...
	options = self:set_defaults({
		...
		Link = "https://google.com" --https://github.com/deeeity/mercury-lib
	}, options)
	...
	creditsTab:credit{Name = "anotherindianfrank", Description = "Developer", Discord = "", V3rmillion = ""}
